...
export default function Create() {
    ...
    async function onSubmitCreate(event: FormEvent<HTMLFormElement>) {
        ...
        const response = await fetch('https://katatataki-bank.lognaze.com/api/coupons', {
            method: 'POST',
        ...
        switch (response.status) {
            case 200:
                ...
                const readableSerialNumber = `${serialNumber.substring(0, 5)}-${serialNumber.substring(5, 10)}-${serialNumber.substring(10, 15)}`;
            ...
            <div className="flex items-center h-[100dvh]">
                <div className="container">
                    ...
                    <form className="needs-validation" onSubmit={onSubmitCreate}>
                        ...
                        <div className="form-floating mb-3">
                            <input className="form-control form-control-lg" type="text" id="memo" name="memo" required minLength={0} maxLength={25} />
                            <label className="form-label" htmlFor="passCode">メモ</label>
                        </div>
                        <div className="form-floating mb-3">
